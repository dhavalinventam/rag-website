    ...
    <footer className={styles.footer}>
      ...
      <div className={`container ${styles.inner}`}>
          ...
          <div className="col-12 col-md-4">
            <div className={styles.brandBlock}>
              ...
              <p className={styles.description}>
                We create digital experiences for forward‑thinking teams using retrieval‑augmented AI
          ...
          <div className="col-6 col-md-4">
            <nav className={`${styles.navBlock} ps-md-5`} aria-label="Quick Links">
              ...
              <ul className={styles.listReset}>
                ...
                <li><Link className={styles.link} href="#terms">Terms of Service</Link></li>
            ...
            <div className={styles.newsletterBlock}>
              ...
              <form className={styles.subscribeForm}>
                <input
                  ...
                  required
                />
                <button className={styles.submitBtn} aria-label="Subscribe" type="button">→</button>
              </form>
        ...
        <div className="row mt-3">
          <div className="col-12"><div className={styles.divider} /></div>
