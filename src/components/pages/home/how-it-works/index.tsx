      ...
      <div className="container">
        <div className={styles.headerSection}>
          ...
          <p className={styles.subtitle}>
            Our streamlined process makes AI implementation effortless. 
            From data connection to deployment, we handle the complexity so you can focus on results.
          </p>
        </div>
          ...
          <div className={styles.timeline}>
              ...
              <div className={styles.stepContent}>
                ...
                <div className={styles.stepInfo}>
                  ...
                  <p className={styles.stepDescription}>
                    Seamlessly integrate your files, databases, or web content. 
                    Our intelligent system handles data ingestion, processing, and optimization automatically.
                  </p>
            ...
            <div className={styles.timelineStep}>
              <div className={styles.stepContent}>
                ...
                <div className={styles.stepIcon}>
                  <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M9 3V5H7C5.89543 5 5 5.89543 5 7V19C5 20.1046 5.89543 21 7 21H17C18.1046 21 19 20.1046 19 19V7C19 5.89543 18.1046 5 17 5H15V3H13V5H11V3H9Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                ...
                <div className={styles.stepInfo}>
                  ...
                  <p className={styles.stepDescription}>
                    Select from our curated collection of state-of-the-art AI models. 
                    Switch between models anytime without any vendor lock-in or migration hassles.
                  </p>
                  <div className={styles.stepFeatures}>
            ...
            <div className={styles.timelineStep}>
              <div className={styles.stepContent}>
                ...
                <div className={styles.stepInfo}>
                  ...
                  <p className={styles.stepDescription}>
                    Launch your AI solution in minutes with enterprise-grade infrastructure. 
                    Scale automatically as your needs grow with zero downtime.
                  </p>
                  <div className={styles.stepFeatures}>
